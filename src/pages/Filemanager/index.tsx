            ...
            <div className="px-3 sm:ml-60 h-500 bg-body-tertiary mt-2 mb-3 font-['Public Sans'] ">
                <Navbar collapseOnSelect expand="lg" className="bg-body-white">
                    ...
                    {/* <Nav className="navbar-nav ml-auto">
                        <div className="flex">
                            <Link href='/Filemanager/Sharedfile'>Shared File</Link>
                            <Button className="mr-7" style={{ borderRadius: '20px', fontSize: '14px', width: '140px' }} >Shared File</Button>
                        </div>
                        </Nav> */}
                </Navbar>
                ...
                <div className="grid px-4 grid-cols-4 grid-row-5 gap-4 ml-5 mr-2">
                    ...
                    <div className="mt-4">
                        <Card className={Styles.cardDiv_1}>
                            <Card.Body>
                                <Button className={Styles.addNewCard_btn} onClick={handleShow}  >+ Upload File</Button>
                    ...
                    <div className="col-span-3 ">
                        <Card className={Styles.cardDiv_2}>
                            <p className="mt-3 font-medium ">My Files</p>
                            <div className="card-1 flex">
                                <Card className="w-40 px-4 py-2 mr-3">
                                    <Image className="mt-3" src={gallaryImgIcon} alt="" />
                                    <p className="mt-2">Photos</p>
                                    <p className={Styles.photos_text}>2451 photos</p>
                                </Card>
                                <Card className="w-40 px-4 py-2 mr-3 ">
                                    <Image className="mt-3" src={youtubeImgIcon} alt="" />
                                    <p className="mt-2">Video</p>
                                    <p className={Styles.photos_text}>31 videos</p>
                                </Card>
                                <Card className="w-40 px-4 py-2 mr-3 ">
                                    <Image className="mt-3" src={videoImgIcon} alt="" />
                                    <p className="mt-2">Audio</p>
                                    <p className={Styles.photos_text}>19 photos</p>
                                </Card>
                                <Card className="w-40 px-4 py-2 mr-3">
                                    <Image className="mt-3" src={folderOpen1Icon} alt="" />
                                    <p className="mt-2">Documents</p>
                                    <p className={Styles.photos_text}>961 files</p>
                                </Card>
                                <Card className="w-40 px-4 py-2">
                                    <Image className="mt-3" src={floppyDiskIcon} alt="" />
                                    <p className="mt-2">Others</p>
                                    <p className={Styles.photos_text}>61 Files</p>
                                </Card>
                            </div>
                        </Card>
                                            ...
                                            <table className="min-w-full text-center text-sm font-light mt-3">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="flex items-start mt-1">
                                                            <Image className="mr-2" src={folderSimpleIcon} alt="" />
                                                            @designerzafor at twitter
                                                        </td>
                                                        <td >Compressed</td>
                                                        <td>128 MB</td>
                                                        <td >8 Sep, 2020 at 5:30 PM
                                                        </td>
                                                        <td> <Image className="" src={menuStandIcon} alt="" /></td>
                                                    </tr>
                                                    <hr style={{ color: 'white' }} />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="flex items-start mt-1">
                                                            <Image className="mr-2" src={folderSimpleIcon} alt="" />
                                                            Dribbble, Behance & Portfolio Project List & Details
                                                        </td>
                                                        <td >PDF file</td>
                                                        <td  >12 MB</td>
                                                        <td >17 Oct, 2020  at 12:43 PM
                                                        </td>
                                                        <td> <Image className="" src={menuStandIcon} alt="" /></td>
                                                    </tr>
                                                    <hr style={{ color: 'white' }} />
